...
tier_3 = [Badger, Blowfish, Camel, Dog, Giraffe, Kangaroo, Ox, Rabbit, Sheep, Snail, Turtle]
tier_4 = [Bison, Deer, Dolphin, Hippo, Parrot, Penguin, Rooster, Skunk, Squirrel, Whale, Worm]
